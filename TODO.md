...
## String 函数
  ...
  - [x] str_shuffle() 随机地打乱字符串中的所有字符。
  - [x] str_split() 把字符串分割到数组中。
  - [x] str_word_count()  计算字符串中的单词数。
...
## Variable handling 函数
  ...
  - [x] is_float() 检测变量是否是浮点型
  - [x] is_int() 检测变量是否是整数
  - [x] is_integer() is_int 的别名
